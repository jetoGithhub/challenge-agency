...
export class AgencyModel {
  ...
  static findByCriteria(data: AgencyEntity[], criteria: string): AgencyEntity[] {
    return  data.filter((agency: AgencyEntity) => {
       return agency.agencia.toLowerCase().includes(criteria.toLowerCase()) || 
   ...
   * @returns AgencyEntity[]
   */
  static create(agency: AgencyEntity, repository: Storage<AgencyEntity[]>): AgencyEntity[] {
   ...
   * @returns AgencyEntity[]
   */
  static update(agency: AgencyEntity, storage: Storage<AgencyEntity[]>): AgencyEntity[] {
